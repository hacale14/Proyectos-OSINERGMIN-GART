<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="NMCompromiso.ascx.vb" Inherits="Controles.NMCompromiso" %>
...
<tr>
    <td>
        ...
        <tr><td colspan="2"><asp:Label ID="lblFechaCompromiso" runat="server" Text="FECHA COMPROMISO"></asp:Label></td></tr>
        <tr>
            <td colspan="2">      
